  ...
  return (
    <AnimatePresence >
      { modalState.showModal && (
        <motion.div 
            className="fixed w-full h-full bg-black bg-opacity-50 z-10 backdrop-blur-sm"
            variants={backdrop}
            initial="hidden"
            animate="visible"
            exit="hidden"
        >
          ...
          >
                ...
                <LabelInputContainer className="mt-3">
                    <Label htmlFor="fullname" className="flex justify-start font-mono text-gray-400 absolute right-4 top-2 text-2xl"
